...
export const TreinoB = ({ fields, form, append, remove }: TypeTreinoB) => {
  return (
    <>
      <Dialog>
                ...
                <React.Fragment key={field.id}>
                  <div className="col-span-3">
                    <FormField
                      ...
                      name={`workout.treino_b.${index}.muscle_group`}
                      render={({ field }) => (
                        <FormItem>
                  ...
                  <div className="col-span-3">
                    <FormField
                      control={form.control}
                      name={`workout.treino_b.${index}.exercise_name`}
                      render={({ field }) => (
                        <FormItem>
                  ...
                  <div className="col-span-1">
                    <FormField
                      control={form.control}
                      name={`workout.treino_b.${index}.sets`}
                      render={({ field }) => (
                        <FormItem>
                  ...
                  <div className="col-span-1">
                    <FormField
                      control={form.control}
                      name={`workout.treino_b.${index}.reps`}
                      render={({ field }) => (
                        <FormItem>
                  ...
                  <div className="col-span-1">
                    <FormField
                      control={form.control}
                      name={`workout.treino_b.${index}.rest`}
                      render={({ field }) => (
                        <FormItem>
                  ...
                  <div className="col-span-2">
                    <FormField
                      control={form.control}
                      name={`workout.treino_b.${index}.workout_group`}
                      render={({ field }) => (
                        <FormItem>
